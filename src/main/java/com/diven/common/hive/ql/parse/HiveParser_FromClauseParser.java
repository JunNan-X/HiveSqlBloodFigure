// $ANTLR 3.4 FromClauseParser.g 2015-05-14 15:09:53
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public final HiveParser_FromClauseParser.tableBucketSample_return tableBucketSample() throws RecognitionException {
        ...
        try {
            ...
            {
            KW_TABLESAMPLE71=(Token)match(input,KW_TABLESAMPLE,FOLLOW_KW_TABLESAMPLE_in_tableBucketSample937); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_KW_TABLESAMPLE.add(KW_TABLESAMPLE71);


            LPAREN72=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_tableBucketSample939); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_LPAREN.add(LPAREN72);


            KW_BUCKET73=(Token)match(input,KW_BUCKET,FOLLOW_KW_BUCKET_in_tableBucketSample941); if (state.failed) return retval; 
            ...
            {
            numerator=(Token)match(input,Number,FOLLOW_Number_in_tableBucketSample946); if (state.failed) return retval; 
            ...
            KW_OUT74=(Token)match(input,KW_OUT,FOLLOW_KW_OUT_in_tableBucketSample949); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_KW_OUT.add(KW_OUT74);


            KW_OF75=(Token)match(input,KW_OF,FOLLOW_KW_OF_in_tableBucketSample951); if (state.failed) return retval; 
            ...
            {
            denominator=(Token)match(input,Number,FOLLOW_Number_in_tableBucketSample956); if (state.failed) return retval; 
            ...
            switch (alt22) {
                case 1 :
                    ...
                    {
                    KW_ON76=(Token)match(input,KW_ON,FOLLOW_KW_ON_in_tableBucketSample960); if (state.failed) return retval; 
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    COMMA77=(Token)match(input,COMMA,FOLLOW_COMMA_in_tableBucketSample967); if (state.failed) return retval; 
            ...
            RPAREN78=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_tableBucketSample977); if (state.failed) return retval; 
        ...
        try {
            ...
            switch (alt24) {
                case 1 :
                    ...
                    {
                    KW_TABLESAMPLE79=(Token)match(input,KW_TABLESAMPLE,FOLLOW_KW_TABLESAMPLE_in_splitSample1024); if (state.failed) return retval; 
                    if ( state.backtracking==0 ) stream_KW_TABLESAMPLE.add(KW_TABLESAMPLE79);


                    LPAREN80=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_splitSample1026); if (state.failed) return retval; 
                    ...
                    {
                    numerator=(Token)match(input,Number,FOLLOW_Number_in_splitSample1032); if (state.failed) return retval; 
                    if ( state.backtracking==0 ) stream_Number.add(numerator);
                    ...
                    switch (alt23) {
                        case 1 :
                            ...
                            {
                            percent=(Token)match(input,KW_PERCENT,FOLLOW_KW_PERCENT_in_splitSample1038); if (state.failed) return retval; 
                        ...
                        case 2 :
                            ...
                            {
                            KW_ROWS81=(Token)match(input,KW_ROWS,FOLLOW_KW_ROWS_in_splitSample1040); if (state.failed) return retval; 
                    ...
                    RPAREN82=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_splitSample1043); if (state.failed) return retval; 
                ...
                case 2 :
                    ...
                    {
                    KW_TABLESAMPLE83=(Token)match(input,KW_TABLESAMPLE,FOLLOW_KW_TABLESAMPLE_in_splitSample1087); if (state.failed) return retval; 
                    if ( state.backtracking==0 ) stream_KW_TABLESAMPLE.add(KW_TABLESAMPLE83);


                    LPAREN84=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_splitSample1089); if (state.failed) return retval; 
                    ...
                    {
                    numerator=(Token)match(input,ByteLengthLiteral,FOLLOW_ByteLengthLiteral_in_splitSample1095); if (state.failed) return retval; 
                    ...
                    RPAREN85=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_splitSample1098); if (state.failed) return retval; 
                ...
                case 1 :
                    ...
                    switch (alt28) {
                        case 1 :
                            // FromClauseParser.g:180:69: KW_AS
                            {
                            KW_AS88=(Token)match(input,KW_AS,FOLLOW_KW_AS_in_tableSource1198); if (state.failed) return retval; 
                    ...
                    alias=(Token)match(input,Identifier,FOLLOW_Identifier_in_tableSource1203); if (state.failed) return retval; 
        ...
        try {
            ...
            switch (alt30) {
                case 1 :
                    ...
                    DOT89=(Token)match(input,DOT,FOLLOW_DOT_in_tableName1265); if (state.failed) return retval; 
        ...
        try {
            ...
            switch (alt31) {
                case 1 :
                    ...
                    DOT90=(Token)match(input,DOT,FOLLOW_DOT_in_viewName1348); if (state.failed) return retval; 
    ...
    public final HiveParser_FromClauseParser.subQuerySource_return subQuerySource() throws RecognitionException {
        ...
        try {
            ...
            {
            LPAREN91=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_subQuerySource1402); if (state.failed) return retval; 
            ...
            RPAREN93=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_subQuerySource1407); if (state.failed) return retval; 
            ...
            switch (alt32) {
                case 1 :
                    // FromClauseParser.g:207:51: KW_AS
                    {
                    KW_AS94=(Token)match(input,KW_AS,FOLLOW_KW_AS_in_subQuerySource1409); if (state.failed) return retval; 
    ...
    public final HiveParser_FromClauseParser.partitionedTableFunction_return partitionedTableFunction() throws RecognitionException {
        ...
        try {
            ...
            {
            name=(Token)match(input,Identifier,FOLLOW_Identifier_in_partitionedTableFunction1607); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_Identifier.add(name);


            LPAREN106=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_partitionedTableFunction1612); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_LPAREN.add(LPAREN106);


            KW_ON107=(Token)match(input,KW_ON,FOLLOW_KW_ON_in_partitionedTableFunction1614); if (state.failed) return retval; 
            ...
            switch (alt37) {
                case 1 :
                    ...
                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) stream_partitioningSpec.add(partitioningSpec108.getTree());
            ...
            switch (alt39) {
                case 1 :
                    ...
                    {
                    Identifier109=(Token)match(input,Identifier,FOLLOW_Identifier_in_partitionedTableFunction1642); if (state.failed) return retval; 
                    if ( state.backtracking==0 ) stream_Identifier.add(Identifier109);


                    LPAREN110=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_partitionedTableFunction1644); if (state.failed) return retval; 
                    ...
                    RPAREN112=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_partitionedTableFunction1648); if (state.failed) return retval; 
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    COMMA113=(Token)match(input,COMMA,FOLLOW_COMMA_in_partitionedTableFunction1652); if (state.failed) return retval; 
                    	    if ( state.backtracking==0 ) stream_COMMA.add(COMMA113);


                    	    Identifier114=(Token)match(input,Identifier,FOLLOW_Identifier_in_partitionedTableFunction1654); if (state.failed) return retval; 
                    	    if ( state.backtracking==0 ) stream_Identifier.add(Identifier114);


                    	    LPAREN115=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_partitionedTableFunction1656); if (state.failed) return retval; 
                    	    ...
                    	    RPAREN117=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_partitionedTableFunction1660); if (state.failed) return retval; 
            ...
            RPAREN118=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_partitionedTableFunction1670); if (state.failed) return retval; 
            ...
            switch (alt40) {
                case 1 :
                    // FromClauseParser.g:238:16: alias= Identifier
                    {
                    alias=(Token)match(input,Identifier,FOLLOW_Identifier_in_partitionedTableFunction1674); if (state.failed) return retval; 
                    if ( state.backtracking==0 ) stream_Identifier.add(alias);
            ...
            // AST REWRITE
            // elements: partitionTableFunctionSource, partitioningSpec, name, alias, expression
    ...
    public final HiveParser_FromClauseParser.whereClause_return whereClause() throws RecognitionException {
        ...
        try {
            ...
            {
            KW_WHERE119=(Token)match(input,KW_WHERE,FOLLOW_KW_WHERE_in_whereClause1734); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_KW_WHERE.add(KW_WHERE119);
            ...
            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) stream_searchCondition.add(searchCondition120.getTree());
    ...
    public final HiveParser_FromClauseParser.valueRowConstructor_return valueRowConstructor() throws RecognitionException {
        ...
        try {
            ...
            {
            LPAREN122=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_valueRowConstructor1802); if (state.failed) return retval; 
            ...
            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) stream_precedenceUnaryPrefixExpression.add(precedenceUnaryPrefixExpression123.getTree());
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    COMMA124=(Token)match(input,COMMA,FOLLOW_COMMA_in_valueRowConstructor1807); if (state.failed) return retval; 
            	    ...
            	    state._fsp--;
            	    if (state.failed) return retval;
            	    if ( state.backtracking==0 ) stream_precedenceUnaryPrefixExpression.add(precedenceUnaryPrefixExpression125.getTree());
            ...
            RPAREN126=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_valueRowConstructor1813); if (state.failed) return retval; 
    ...
    public final HiveParser_FromClauseParser.valuesTableConstructor_return valuesTableConstructor() throws RecognitionException {
        ...
        try {
            ...
            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) stream_valueRowConstructor.add(valueRowConstructor127.getTree());
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    COMMA128=(Token)match(input,COMMA,FOLLOW_COMMA_in_valuesTableConstructor1846); if (state.failed) return retval; 
            	    ...
            	    state._fsp--;
            	    if (state.failed) return retval;
            	    if ( state.backtracking==0 ) stream_valueRowConstructor.add(valueRowConstructor129.getTree());
    ...
    public final HiveParser_FromClauseParser.valuesClause_return valuesClause() throws RecognitionException {
        ...
        try {
            ...
            {
            KW_VALUES130=(Token)match(input,KW_VALUES,FOLLOW_KW_VALUES_in_valuesClause1882); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_KW_VALUES.add(KW_VALUES130);
            ...
            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) stream_valuesTableConstructor.add(valuesTableConstructor131.getTree());
    ...
    public final HiveParser_FromClauseParser.virtualTableSource_return virtualTableSource() throws RecognitionException {
        ...
        try {
            ...
            {
            LPAREN132=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_virtualTableSource1911); if (state.failed) return retval; 
            ...
            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) stream_valuesClause.add(valuesClause133.getTree());

            RPAREN134=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_virtualTableSource1915); if (state.failed) return retval; 
            ...
            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) stream_tableNameColList.add(tableNameColList135.getTree());
        ...
        try {
            ...
            switch (alt43) {
                case 1 :
                    // FromClauseParser.g:298:5: KW_AS
                    {
                    KW_AS136=(Token)match(input,KW_AS,FOLLOW_KW_AS_in_tableNameColList1949); if (state.failed) return retval; 
            ...
            LPAREN138=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_tableNameColList1954); if (state.failed) return retval; 
            ...
            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) stream_identifier.add(identifier139.getTree());
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    COMMA140=(Token)match(input,COMMA,FOLLOW_COMMA_in_tableNameColList1959); if (state.failed) return retval; 
            ...
            RPAREN142=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_tableNameColList1965); if (state.failed) return retval; 
    ...
    public final void synpred4_FromClauseParser_fragment() throws RecognitionException {
        ...
        {
        match(input,Identifier,FOLLOW_Identifier_in_synpred4_FromClauseParser1630); if (state.failed) return ;

        match(input,LPAREN,FOLLOW_LPAREN_in_synpred4_FromClauseParser1632); if (state.failed) return ;
        ...
        match(input,RPAREN,FOLLOW_RPAREN_in_synpred4_FromClauseParser1636); if (state.failed) return ;
    ...
    static final String[] DFA14_transitionS = {
            "\1\3\52\uffff\1\1\15\uffff\1\1\26\uffff\1\1\32\uffff\1\1\3\uffff"+
            "\1\1\1\uffff\1\1\10\uffff\1\1\3\uffff\1\1\6\uffff\1\1\2\uffff"+
            "\2\1\2\uffff\1\1\11\uffff\1\1\14\uffff\1\1\2\uffff\1\1\33\uffff"+
            "\1\1\7\uffff\1\1\10\uffff\1\1\13\uffff\1\1\32\uffff\1\1\21\uffff"+
            "\1\1\1\uffff\1\1\4\uffff\1\1\12\uffff\1\1",
            "",
            "",
            "\1\33\6\34\1\uffff\17\34\2\uffff\1\34\1\uffff\4\34\1\uffff"+
            "\6\34\1\uffff\2\34\1\uffff\1\34\1\uffff\2\34\1\uffff\20\34\1"+
            "\uffff\4\34\1\uffff\1\34\1\uffff\1\34\1\uffff\4\34\1\uffff\10"+
            "\34\1\uffff\3\34\1\uffff\1\34\1\uffff\4\34\1\uffff\2\34\1\uffff"+
            "\20\34\1\uffff\4\34\1\uffff\12\34\2\uffff\3\34\1\uffff\3\34"+
            "\1\uffff\4\34\1\uffff\1\34\1\uffff\5\34\1\uffff\2\34\1\uffff"+
            "\5\34\2\uffff\14\34\1\uffff\20\34\1\uffff\25\34\1\uffff\3\34"+
    ...
    static final String DFA19_minS =
        "\1\32\1\12\1\uffff\1\164\1\7\76\uffff";
    static final String DFA19_maxS =
        "\1\u011d\1\u0128\1\uffff\1\u0119\1\u0130\76\uffff";
    static final String DFA19_acceptS =
        "\2\uffff\1\2\37\uffff\1\3\5\uffff\1\4\1\1\31\uffff";
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    case 0 : 
                        ...
                        s = -1;
                        if ( (LA19_4==KW_ON) && (synpred3_FromClauseParser())) {s = 41;}

                        else if ( (LA19_4==BigintLiteral||LA19_4==CharSetName||LA19_4==DecimalLiteral||(LA19_4 >= Identifier && LA19_4 <= KW_ANALYZE)||(LA19_4 >= KW_ARCHIVE && LA19_4 <= KW_CHANGE)||(LA19_4 >= KW_CLUSTER && LA19_4 <= KW_COLLECTION)||(LA19_4 >= KW_COLUMNS && LA19_4 <= KW_CONCATENATE)||(LA19_4 >= KW_CONTINUE && LA19_4 <= KW_CREATE)||LA19_4==KW_CUBE||(LA19_4 >= KW_CURSOR && LA19_4 <= KW_DATA)||(LA19_4 >= KW_DATABASES && LA19_4 <= KW_DISABLE)||(LA19_4 >= KW_DISTRIBUTE && LA19_4 <= KW_ELEM_TYPE)||LA19_4==KW_ENABLE||LA19_4==KW_ESCAPED||(LA19_4 >= KW_EXCLUSIVE && LA19_4 <= KW_EXPORT)||(LA19_4 >= KW_EXTERNAL && LA19_4 <= KW_FLOAT)||(LA19_4 >= KW_FOR && LA19_4 <= KW_FORMATTED)||LA19_4==KW_FULL||(LA19_4 >= KW_FUNCTIONS && LA19_4 <= KW_GROUPING)||(LA19_4 >= KW_HOLD_DDLTIME && LA19_4 <= KW_JAR)||(LA19_4 >= KW_KEYS && LA19_4 <= KW_LEFT)||(LA19_4 >= KW_LIKE && LA19_4 <= KW_LONG)||(LA19_4 >= KW_MAP && LA19_4 <= KW_MINUS)||(LA19_4 >= KW_MSCK && LA19_4 <= KW_OFFLINE)||LA19_4==KW_OPTION||(LA19_4 >= KW_ORDER && LA19_4 <= KW_OUTPUTFORMAT)||(LA19_4 >= KW_OVERWRITE && LA19_4 <= KW_OWNER)||(LA19_4 >= KW_PARTITION && LA19_4 <= KW_PLUS)||(LA19_4 >= KW_PRETTY && LA19_4 <= KW_RECORDWRITER)||(LA19_4 >= KW_REGEXP && LA19_4 <= KW_SCHEMAS)||(LA19_4 >= KW_SEMI && LA19_4 <= KW_TABLES)||(LA19_4 >= KW_TBLPROPERTIES && LA19_4 <= KW_TERMINATED)||(LA19_4 >= KW_TIMESTAMP && LA19_4 <= KW_TRANSACTIONS)||(LA19_4 >= KW_TRIGGER && LA19_4 <= KW_UNARCHIVE)||(LA19_4 >= KW_UNDO && LA19_4 <= KW_UNIONTYPE)||(LA19_4 >= KW_UNLOCK && LA19_4 <= KW_VALUE_TYPE)||LA19_4==KW_VIEW||LA19_4==KW_WHILE||LA19_4==KW_WITH||LA19_4==LPAREN||LA19_4==MINUS||(LA19_4 >= Number && LA19_4 <= PLUS)||(LA19_4 >= SmallintLiteral && LA19_4 <= TinyintLiteral)) ) {s = 2;}
            "\uffff\1\2\3\uffff\1\2\1\uffff\1\2\10\uffff\1\2\3\uffff\1\2"+
            "\6\uffff\1\2\2\uffff\2\2\2\uffff\1\2\11\uffff\1\2\14\uffff\1"+
            "\2\2\uffff\1\2\10\uffff\1\2\22\uffff\1\2\7\uffff\1\2\10\uffff"+
            "\1\2\13\uffff\1\2\32\uffff\1\2\21\uffff\1\2\1\uffff\1\2\4\uffff"+
            "\1\2\12\uffff\1\2",
            "\1\36\17\uffff\1\36\32\uffff\1\36\15\uffff\1\36\26\uffff\1"+
            "\36\32\uffff\1\36\3\uffff\1\36\1\uffff\1\36\10\uffff\1\36\3"+
            "\uffff\1\36\6\uffff\1\36\2\uffff\2\36\2\uffff\1\36\11\uffff"+
            "\1\36\14\uffff\1\36\2\uffff\1\36\10\uffff\1\36\22\uffff\1\36"+
            "\7\uffff\1\36\10\uffff\1\36\13\uffff\1\36\32\uffff\1\36\21\uffff"+
            ...
            "\1\121\1\112\15\121\1\110\1\107\1\121\1\uffff\4\121\1\uffff"+
            "\6\121\1\uffff\2\121\1\uffff\1\121\1\uffff\2\121\1\uffff\1\121"+
            "\1\75\16\121\1\uffff\4\121\1\uffff\1\121\1\uffff\1\121\1\uffff"+
            "\1\121\1\117\2\121\1\uffff\1\121\1\106\6\121\1\uffff\3\121\1"+
            "\uffff\1\121\1\uffff\4\121\1\uffff\2\121\1\111\20\121\1\uffff"+
            "\4\121\1\uffff\12\121\1\uffff\1\113\3\121\1\uffff\3\121\1\71"+
            "\1\121\1\73\2\121\1\uffff\1\121\1\uffff\5\121\1\uffff\2\121"+
            "\1\uffff\5\121\2\uffff\14\121\1\uffff\20\121\1\uffff\22\121"+
            "\1\114\2\121\1\uffff\3\121\1\uffff\1\76\4\121\1\uffff\1\121"+
            "\1\105\2\121\1\uffff\2\121\1\115\1\uffff\14\121\1\uffff\1\121"+
            "\2\uffff\1\121\1\uffff\1\121\3\uffff\1\120\2\uffff\1\72\2\uffff"+
            "\1\74\1\72\10\uffff\1\101\1\77\1\72\1\102",
            "",
            "",
            "",
            "",
    ...
    public static final BitSet FOLLOW_DOT_in_tableAllColumns81 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000100000000000L});
    ...
    public static final BitSet FOLLOW_COMMA_in_expressionList173 = new BitSet(new long[]{0xFDEFFFFDFC042080L,0xF7AEFF7ABDFFFED6L,0x3EDF5FEF7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x0001E0192297FFBBL});
    ...
    public static final BitSet FOLLOW_COMMA_in_aliasList220 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_identifier_in_aliasList222 = new BitSet(new long[]{0x0000000000000402L});
    public static final BitSet FOLLOW_KW_FROM_in_fromClause266 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000002297FFFBL});
    public static final BitSet FOLLOW_joinSource_in_fromClause268 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_fromSource_in_joinSource303 = new BitSet(new long[]{0x0000000000000402L,0x0020000000000008L,0x0000000000088010L,0x0000000000100000L});
    public static final BitSet FOLLOW_joinToken_in_joinSource307 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000002297FFBBL});
    public static final BitSet FOLLOW_fromSource_in_joinSource310 = new BitSet(new long[]{0x0000000000000402L,0x0020000000000008L,0x0000200000088010L,0x0000000000100000L});
    public static final BitSet FOLLOW_KW_ON_in_joinSource314 = new BitSet(new long[]{0xFDEFFFFDFC042080L,0xF7AEFF7ABDFFFED6L,0x3EDF5FEF7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x0001E0192297FFBBL});
    public static final BitSet FOLLOW_expression_in_joinSource317 = new BitSet(new long[]{0x0000000000000402L,0x0020000000000008L,0x0000000000088010L,0x0000000000100000L});
    public static final BitSet FOLLOW_uniqueJoinToken_in_joinSource333 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0xBEDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000002297FFBBL});
    public static final BitSet FOLLOW_uniqueJoinSource_in_joinSource336 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_COMMA_in_joinSource339 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0xBEDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000002297FFBBL});
    public static final BitSet FOLLOW_uniqueJoinSource_in_joinSource342 = new BitSet(new long[]{0x0000000000000402L});
    public static final BitSet FOLLOW_KW_PRESERVE_in_uniqueJoinSource371 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000002297FFBBL});
    public static final BitSet FOLLOW_fromSource_in_uniqueJoinSource374 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_uniqueJoinExpr_in_uniqueJoinSource376 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LPAREN_in_uniqueJoinExpr403 = new BitSet(new long[]{0xFDEFFFFDFC042080L,0xF7AEFF7ABDFFFED6L,0x3EDF5FEF7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x0001E0192297FFBBL});
    public static final BitSet FOLLOW_expression_in_uniqueJoinExpr407 = new BitSet(new long[]{0x0000000000000400L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_COMMA_in_uniqueJoinExpr410 = new BitSet(new long[]{0xFDEFFFFDFC042080L,0xF7AEFF7ABDFFFED6L,0x3EDF5FEF7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x0001E0192297FFBBL});
    public static final BitSet FOLLOW_expression_in_uniqueJoinExpr414 = new BitSet(new long[]{0x0000000000000400L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    ...
    public static final BitSet FOLLOW_KW_INNER_in_joinToken526 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000008000L});
    ...
    public static final BitSet FOLLOW_KW_CROSS_in_joinToken587 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000008000L});
    public static final BitSet FOLLOW_KW_JOIN_in_joinToken589 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KW_LEFT_in_joinToken613 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0004000000008000L});
    public static final BitSet FOLLOW_KW_OUTER_in_joinToken617 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000008000L});
    public static final BitSet FOLLOW_KW_JOIN_in_joinToken621 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KW_RIGHT_in_joinToken633 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0004000000008000L});
    public static final BitSet FOLLOW_KW_OUTER_in_joinToken636 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000008000L});
    public static final BitSet FOLLOW_KW_JOIN_in_joinToken640 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KW_FULL_in_joinToken652 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0004000000008000L});
    public static final BitSet FOLLOW_KW_OUTER_in_joinToken656 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000008000L});
    ...
    public static final BitSet FOLLOW_KW_SEMI_in_joinToken674 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000008000L});
    public static final BitSet FOLLOW_KW_JOIN_in_joinToken676 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KW_LATERAL_in_lateralView710 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000100000L});
    public static final BitSet FOLLOW_KW_VIEW_in_lateralView712 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0004000000000000L});
    public static final BitSet FOLLOW_KW_OUTER_in_lateralView714 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xF7AEFF7ABDFFFED6L,0x3EDF5EEF7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_function_in_lateralView716 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_tableAlias_in_lateralView718 = new BitSet(new long[]{0x0000001000000002L});
    public static final BitSet FOLLOW_KW_AS_in_lateralView721 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_identifier_in_lateralView723 = new BitSet(new long[]{0x0000000000000402L});
    public static final BitSet FOLLOW_COMMA_in_lateralView731 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_identifier_in_lateralView733 = new BitSet(new long[]{0x0000000000000402L});
    public static final BitSet FOLLOW_KW_LATERAL_in_lateralView765 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000100000L});
    public static final BitSet FOLLOW_KW_VIEW_in_lateralView767 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xF7AEFF7ABDFFFED6L,0x3EDF5EEF7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_function_in_lateralView769 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_tableAlias_in_lateralView771 = new BitSet(new long[]{0x0000001000000002L});
    public static final BitSet FOLLOW_KW_AS_in_lateralView774 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_identifier_in_lateralView776 = new BitSet(new long[]{0x0000000000000402L});
    public static final BitSet FOLLOW_COMMA_in_lateralView784 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    ...
    public static final BitSet FOLLOW_partitionedTableFunction_in_fromSource887 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000040000L});
    public static final BitSet FOLLOW_tableSource_in_fromSource891 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000040000L});
    public static final BitSet FOLLOW_subQuerySource_in_fromSource895 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000040000L});
    public static final BitSet FOLLOW_virtualTableSource_in_fromSource899 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000040000L});
    public static final BitSet FOLLOW_lateralView_in_fromSource903 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000040000L});
    public static final BitSet FOLLOW_KW_TABLESAMPLE_in_tableBucketSample937 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_LPAREN_in_tableBucketSample939 = new BitSet(new long[]{0x0000200000000000L});
    public static final BitSet FOLLOW_KW_BUCKET_in_tableBucketSample941 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000800000000L});
    public static final BitSet FOLLOW_Number_in_tableBucketSample946 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0002000000000000L});
    public static final BitSet FOLLOW_KW_OUT_in_tableBucketSample949 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_KW_OF_in_tableBucketSample951 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000800000000L});
    public static final BitSet FOLLOW_Number_in_tableBucketSample956 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000200000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_KW_ON_in_tableBucketSample960 = new BitSet(new long[]{0xFDEFFFFDFC042080L,0xF7AEFF7ABDFFFED6L,0x3EDF5FEF7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x0001E0192297FFBBL});
    public static final BitSet FOLLOW_expression_in_tableBucketSample964 = new BitSet(new long[]{0x0000000000000400L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_COMMA_in_tableBucketSample967 = new BitSet(new long[]{0xFDEFFFFDFC042080L,0xF7AEFF7ABDFFFED6L,0x3EDF5FEF7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x0001E0192297FFBBL});
    public static final BitSet FOLLOW_expression_in_tableBucketSample971 = new BitSet(new long[]{0x0000000000000400L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_RPAREN_in_tableBucketSample977 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KW_TABLESAMPLE_in_splitSample1024 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_LPAREN_in_splitSample1026 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000800000000L});
    public static final BitSet FOLLOW_Number_in_splitSample1032 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x1000000000000000L,0x0000000004000000L});
    public static final BitSet FOLLOW_KW_PERCENT_in_splitSample1038 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_KW_ROWS_in_splitSample1040 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_RPAREN_in_splitSample1043 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KW_TABLESAMPLE_in_splitSample1087 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_LPAREN_in_splitSample1089 = new BitSet(new long[]{0x0000000000000100L});
    public static final BitSet FOLLOW_ByteLengthLiteral_in_splitSample1095 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    ...
    public static final BitSet FOLLOW_tableName_in_tableSource1181 = new BitSet(new long[]{0x0000001004000002L,0x0000000000000000L,0x0000000000000000L,0x0008000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_tableProperties_in_tableSource1186 = new BitSet(new long[]{0x0000001004000002L,0x0000000000000000L,0x0000000000000000L,0x0008000000000000L});
    ...
    public static final BitSet FOLLOW_DOT_in_tableName1265 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    ...
    public static final BitSet FOLLOW_DOT_in_viewName1348 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_identifier_in_viewName1354 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LPAREN_in_subQuerySource1402 = new BitSet(new long[]{0x0000000000000000L,0x0010000000000000L,0x0000000100000100L,0x0000000020001000L,0x0000000002000000L});
    public static final BitSet FOLLOW_queryStatementExpression_in_subQuerySource1404 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_RPAREN_in_subQuerySource1407 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_KW_AS_in_subQuerySource1409 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_identifier_in_subQuerySource1412 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_partitionByClause_in_partitioningSpec1453 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0001000000000000L});
    ...
    public static final BitSet FOLLOW_distributeByClause_in_partitioningSpec1489 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000000000L,0x0000020000000000L});
    ...
    public static final BitSet FOLLOW_clusterByClause_in_partitioningSpec1525 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_subQuerySource_in_partitionTableFunctionSource1562 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_tableSource_in_partitionTableFunctionSource1569 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_partitionedTableFunction_in_partitionTableFunctionSource1576 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_Identifier_in_partitionedTableFunction1607 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_LPAREN_in_partitionedTableFunction1612 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000200000000000L});
    public static final BitSet FOLLOW_KW_ON_in_partitionedTableFunction1614 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000002297FFBBL});
    public static final BitSet FOLLOW_partitionTableFunctionSource_in_partitionedTableFunction1618 = new BitSet(new long[]{0x0020000004000000L,0x0000000004000000L,0x0201000000000000L,0x0000020000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_partitioningSpec_in_partitionedTableFunction1620 = new BitSet(new long[]{0x0000000004000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_Identifier_in_partitionedTableFunction1642 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_LPAREN_in_partitionedTableFunction1644 = new BitSet(new long[]{0xFDEFFFFDFC042080L,0xF7AEFF7ABDFFFED6L,0x3EDF5FEF7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x0001E0192297FFBBL});
    public static final BitSet FOLLOW_expression_in_partitionedTableFunction1646 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_RPAREN_in_partitionedTableFunction1648 = new BitSet(new long[]{0x0000000000000400L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_COMMA_in_partitionedTableFunction1652 = new BitSet(new long[]{0x0000000004000000L});
    public static final BitSet FOLLOW_Identifier_in_partitionedTableFunction1654 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_LPAREN_in_partitionedTableFunction1656 = new BitSet(new long[]{0xFDEFFFFDFC042080L,0xF7AEFF7ABDFFFED6L,0x3EDF5FEF7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x0001E0192297FFBBL});
    public static final BitSet FOLLOW_expression_in_partitionedTableFunction1658 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_RPAREN_in_partitionedTableFunction1660 = new BitSet(new long[]{0x0000000000000400L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_RPAREN_in_partitionedTableFunction1670 = new BitSet(new long[]{0x0000000004000002L});
    public static final BitSet FOLLOW_Identifier_in_partitionedTableFunction1674 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KW_WHERE_in_whereClause1734 = new BitSet(new long[]{0xFDEFFFFDFC042080L,0xF7AEFF7ABDFFFED6L,0x3EDF5FEF7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x0001E0192297FFBBL});
    ...
    public static final BitSet FOLLOW_LPAREN_in_valueRowConstructor1802 = new BitSet(new long[]{0xFDEFFFFDFC042080L,0xF7AEFF7ABDFFFED6L,0x3EDF5EEF7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x0001E0192297FFBBL});
    public static final BitSet FOLLOW_precedenceUnaryPrefixExpression_in_valueRowConstructor1804 = new BitSet(new long[]{0x0000000000000400L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_COMMA_in_valueRowConstructor1807 = new BitSet(new long[]{0xFDEFFFFDFC042080L,0xF7AEFF7ABDFFFED6L,0x3EDF5EEF7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x0001E0192297FFBBL});
    public static final BitSet FOLLOW_precedenceUnaryPrefixExpression_in_valueRowConstructor1809 = new BitSet(new long[]{0x0000000000000400L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_RPAREN_in_valueRowConstructor1813 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_valueRowConstructor_in_valuesTableConstructor1843 = new BitSet(new long[]{0x0000000000000402L});
    public static final BitSet FOLLOW_COMMA_in_valuesTableConstructor1846 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_valueRowConstructor_in_valuesTableConstructor1848 = new BitSet(new long[]{0x0000000000000402L});
    public static final BitSet FOLLOW_KW_VALUES_in_valuesClause1882 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_valuesTableConstructor_in_valuesClause1884 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LPAREN_in_virtualTableSource1911 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_valuesClause_in_virtualTableSource1913 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_RPAREN_in_virtualTableSource1915 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_tableNameColList_in_virtualTableSource1917 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KW_AS_in_tableNameColList1949 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_identifier_in_tableNameColList1952 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_LPAREN_in_tableNameColList1954 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_identifier_in_tableNameColList1956 = new BitSet(new long[]{0x0000000000000400L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_COMMA_in_tableNameColList1959 = new BitSet(new long[]{0xFDE9FFFDFC000000L,0xB7AEFF7ABDFFFED6L,0x3EDF5EEE7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x000000000297FFBBL});
    public static final BitSet FOLLOW_identifier_in_tableNameColList1961 = new BitSet(new long[]{0x0000000000000400L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    ...
    public static final BitSet FOLLOW_Identifier_in_synpred3_FromClauseParser881 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_LPAREN_in_synpred3_FromClauseParser883 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_Identifier_in_synpred4_FromClauseParser1630 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000020000000L});
    public static final BitSet FOLLOW_LPAREN_in_synpred4_FromClauseParser1632 = new BitSet(new long[]{0xFDEFFFFDFC042080L,0xF7AEFF7ABDFFFED6L,0x3EDF5FEF7FEF7FFFL,0xDF77FFFFDFFFEFFFL,0x0001E0192297FFBBL});
    public static final BitSet FOLLOW_expression_in_synpred4_FromClauseParser1634 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000010000000000L});
    public static final BitSet FOLLOW_RPAREN_in_synpred4_FromClauseParser1636 = new BitSet(new long[]{0x0000000000000002L});
